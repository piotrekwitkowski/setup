...
const desiredClaudeSettings = {
  ...
  permissions: {
    ...
    allow: [
      ...
      "Bash(brazil help *)",
      "Bash(brazil version)",
      "Bash(brazil versionset listplatforms)",
      "Bash(brazil vs listplatforms)",
      "Bash(brazil workspace show)",
      "Bash(brazil ws show)",
      "Bash(brazil-context *)",
      "Bash(brazil-path *)",
      "Bash(cat *)",
      ...
      "mcp__builder-mcp__GetSoftwareRecommendation",
      ...
      "mcp__builder-mcp__TaskeiGetRoomResources",
